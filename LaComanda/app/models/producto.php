<?php
    ...
    class producto{
        ...
        public function InsertarProducto(){
            ...
            $consulta = $objetoAccsesoDatos->RetornarConsulta("INSERT INTO `productos`(`nombre`, `precio`, `tiempo_eleboracion`, `sector`) 
        ...
        public static function traerTodosLosProductos(){
            $objetoAccsesoDatos = AccesoDatos::dameUnObjetoAcceso();
            $consulta = $objetoAccsesoDatos->RetornarConsulta("SELECT `id`, `nombre`, `precio`, `tiempo_eleboracion` AS 'tiempoElaboracion', `sector` 
            FROM `productos` ");
            $consulta->execute();
        ...
        public static function TraerUnProducto($id){
            ...
            $consulta = $objetoAccesoDato->RetornarConsulta("SELECT `id`, `nombre`, `precio`, `tiempo_eleboracion` AS 'tiempoElaboracion', `sector` 
            FROM `productos` 
            WHERE id = $id");
            $consulta->execute();
        ...
        public function modificarProducto(){
            ...
            SET `nombre`='$this->nombre',`precio`= '$this->precio',`tiempo_eleboracion`='$this->tiempoElaboracion',`sector`='$this->sector' 
            WHERE id = '$this->id'");
        ...
        public function modificarProductoParametros(){
            $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
            $consulta = $objetoAccesoDato->RetornarConsulta("UPDATE `productos` 
            SET `nombre`= :nombre,`precio`= :precio,`tiempo_eleboracion`= :tiempoElaboracion,`sector`= :sector 
            WHERE id = :id");
