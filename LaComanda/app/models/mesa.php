<?php
    ...
    class mesa{
        ...
        public function InsertarMesa(){
            ...
            $consulta = $objetoAccsesoDatos->RetornarConsulta("INSERT INTO `mesas`(`id_mozo`, `codigo_numerico`, `estado`) 
        ...
        public static function traerTodosLasMesas(){
            $objetoAccsesoDatos = AccesoDatos::dameUnObjetoAcceso();
            $consulta = $objetoAccsesoDatos->RetornarConsulta("SELECT `id`, `id_mozo` AS 'idMozo', `codigo_numerico` AS 'codigoNumerico', `estado` 
            FROM `mesas` ");
            $consulta->execute();
        ...
        public static function TraerUnaMesa($id){
            ...
            $consulta = $objetoAccesoDato->RetornarConsulta("SELECT `id`, `id_mozo` AS 'idMozo', `codigo_numerico` AS 'codigoNumerico', `estado` 
            FROM `mesas` 
            WHERE id = $id");
            $consulta->execute();
        ...
        public function modificarMesa(){
            ...
            SET `id_mozo`= '$this->idMozo',`codigo_numerico`= '$this->codigoNumerico',`estado`='$this->estado' 
            WHERE id = '$this->id' ");
        ...
        public function modificarMesaParametros(){
            $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
            $consulta = $objetoAccesoDato->RetornarConsulta("UPDATE `mesas` 
            SET `id_mozo`= :idMozo,`codigo_numerico`= :codigoNumerico,`estado`= :estado 
            WHERE id = :id ");
